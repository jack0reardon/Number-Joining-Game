...
class Game:
    def __init__(self, filename, width_in_pxls_max, height_in_pxls_max, grey_percentile_cutoff, max_length=None):
        ...
        rgb_image.to_greyscale(grey_percentile_cutoff)
...
if __name__ == '__main__':
    the_game = Game('C:/Users/sexy0/Documents/Python/Dog.jpeg', width_in_pxls_max = 50, height_in_pxls_max = 50, grey_percentile_cutoff=config['DEFAULT_GREY_PERCENTILE_CUTOFF'], max_length = 10)
    # the_game = Game('C:/Users/sexy0/Documents/Python/Uluru.jpeg', width_in_pxls_max = 100, height_in_pxls_max = 100, grey_percentile_cutoff=config['DEFAULT_GREY_PERCENTILE_CUTOFF'], max_length = 10)
